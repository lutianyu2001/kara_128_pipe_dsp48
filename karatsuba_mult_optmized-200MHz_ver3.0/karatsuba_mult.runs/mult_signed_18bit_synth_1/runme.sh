...
HD_PWD='D:/work/UIC_Course/DigitalCircuitsDesign/Project/karatsuba_mult/karatsuba_mult.runs/mult_signed_18bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_signed_18bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_signed_18bit.tcl
