...
synth_design -top karatsuba_top -part xc7z020clg400-2 -fanout_limit 400 -fsm_extraction one_hot -keep_equivalent_registers -resource_sharing off -no_lc -shreg_min_size 5


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef karatsuba_top.dcp
create_report "synth_flow_PerfOptimized-high_synth_report_utilization_0" "report_utilization -file karatsuba_top_utilization_synth.rpt -pb karatsuba_top_utilization_synth.pb"
